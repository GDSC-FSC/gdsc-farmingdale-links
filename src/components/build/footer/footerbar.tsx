	...
	return (
      ...
      `,
		...
		>
			<Div
				className={cn(
					`flex items-center justify-center max-w-screen-xl mx-auto px-4  sm:px-6 lg:px-8 h-full`,
					className,
				)}
			>
				<Div
					className={`gap-8 flex flex-row items-center w-full ${
						!isLegal ? "justify-between" : "justify-center"
					}`}
				>
					<Div
						className={`
