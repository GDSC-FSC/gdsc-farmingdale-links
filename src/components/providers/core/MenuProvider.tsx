...
export function ContextMenuProvider({
	...
	return (
		<ContextMenu>
			<ContextMenuTrigger className="flex items-center justify-center w-screen h-screen text-sm absolute z-10 top-0 left-0" />
			<ContextMenuContent
				className={`w-64 `}
				style={{
            ...
            `}
				...
				{!hideCarouselOptions && (
					<>
						<ContextMenuItem
							inset
							onClick={handleSwitchToImageCarousel}
							className={` font-normal text-white`}
						>
							Image Carousel
						</ContextMenuItem>
						{isOnline && (
							<ContextMenuItem
								inset
								onClick={handleSwitchToVideoCarousel}
								className={` font-normal text-white `}
							>
								Video Carousel
							</ContextMenuItem>
