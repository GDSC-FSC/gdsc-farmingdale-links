...
export const isAndroidChrome = (): boolean =>
	getBrowser() === "chrome" && isAndroid();
export const isMacOSChrome = (): boolean =>
	getBrowser() === "chrome" && isMacOS();
export const isWindowsChrome = (): boolean =>
	getBrowser() === "chrome" && isWindows();
export const isIOSFirefox = (): boolean =>
	getBrowser() === "firefox" && isIOS();
export const isAndroidFirefox = (): boolean =>
	getBrowser() === "firefox" && isAndroid();
export const isIOSEdge = (): boolean => getBrowser() === "edge" && isIOS();
export const isAndroidEdge = (): boolean =>
	getBrowser() === "edge" && isAndroid();
export const isMacOSEdge = (): boolean => getBrowser() === "edge" && isMacOS();
export const isWindowsEdge = (): boolean =>
	getBrowser() === "edge" && isWindows();
export const isIOSOpera = (): boolean => getBrowser() === "opera" && isIOS();
export const isAndroidOpera = (): boolean =>
	getBrowser() === "opera" && isAndroid();
