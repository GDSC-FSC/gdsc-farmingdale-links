...
export const Component = function Terms(): JSX.Element {
	...
	return (
        ...
        `}
				>
					We, {appName}, reserve the right to review and amend any of these
        ...
        `}
				>
					...
					are owned by or licensed to {appName} and are protected by applicable
        ...
        `}
				>
					...
					for general information purposes only. {appName} does not warrant or
        ...
        `}
				>
					{appName} has not reviewed all of the sites linked to its website and
